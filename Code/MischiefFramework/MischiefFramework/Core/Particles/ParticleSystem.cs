...
namespace MischiefFramework.Core.Particles
{
    ...
    /// </summary>
    internal abstract class ParticleSystem : Asset, ITransparent {
        #region Fields
        ...
        public void Initialize() {
            ...
            vertexBuffer = new DynamicVertexBuffer(Game.device, ParticleVertex.VertexDeclaration,
            ...
            indexBuffer = new IndexBuffer(Game.device, typeof(ushort), indices.Length, BufferUsage.WriteOnly);
        ...
        void LoadParticleEffect() {
            Effect effect = ResourceManager.LoadAsset<Effect>("Shaders/ParticleEffect");
        ...
        public void RenderTransparent() {
            GraphicsDevice device = Game.device;

            this.particleEffect.Parameters["DepthTexture"].SetValue(Renderer.DepthRT);
